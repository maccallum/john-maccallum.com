<?php
header('Location: http://john-maccallum.com/index.php?'.$_SERVER['QUERY_STRING']);
die();
$mainpage = "index.alpha.php";
$dim = NULL;
$indices = NULL;
$page = $_GET["page"];
...
$excludes = array("index.php" => true, "index.alpha.php" => true, "index.php.bak" => true, "bg.png" => true, "map.txt" => true, "dontmessup" => true, "log.txt" => true, "dl" => true, "niftyplayer" => true, "make-bg.pl" => true, "favicon.gif" => true, "favicon.ico" => true, "test.php" => true, "wind.js" => true, "title.txt" => true, "diss" => true, "blog" => true, "blog.old" => true, "dav" => true, "wp-content" => true);
